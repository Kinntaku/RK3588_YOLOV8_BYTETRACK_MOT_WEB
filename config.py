OBJ_THRESH, NMS_THRESH, IMG_SIZE = 0.3, 0.9,1024


TARGET_CLASSES ={"person"} #填写自己需要追踪的类别
...
model = "./rknnModel/ch_best_180_1024.rknn" #使用crowdhuman数据集训练200次的1024输入大小，relu作为激活函数的模型
